...
_APELLIDOS = {
    "GARCIA", "RODRIGUEZ", "MARTINEZ", "LOPEZ", "<NOMBRE>", "HERNANDEZ", "PEREZ",
    "<NOMBRE>", "RAMIREZ", "<NOMBRE>", "FLOREZ", "FLORES", "<NOMBRE>", "GOMEZ", "DIAZ",
    "REYES", "MORALES", "JIMENEZ", "RUIZ", "<NOMBRE>", "<NOMBRE>", "MUNOZ", "<NOMBRE>",
    "MEDINA", "CASTRO", "ORTIZ", "RAMOS", "SUAREZ", "VARGAS", "CASTILLO", "ROMERO",
    "HERRERA", "MENDOZA", "GUERRERO", "SANDOVAL", "<NOMBRE>", "LANCHEROS", "AFANADOR",
    "<NOMBRE>", "LINARES", "RICARDO", "GARNICA", "CONTRERAS", "<NOMBRE>", "NAVARRO",
    ...
    "MOLINA", "OCHOA", "PARDO", "PRIETO", "RUEDA", "<NOMBRE>", "SOTO", "VALENCIA",
    ...
    "GELVEZ", "NORIEGA", "MANTILLA", "<NOMBRE>", "ESPINOSA", "FAJARDO", "ORTEGA", "ROA",
    "SOLANO", "TELLEZ", "ZAMBRANO", "BARRIOS", "CESPEDES", "CHACON", "DELGADO", "ESTUPINAN",
}
_NOMBRES_PILA = {
    "<NOMBRE>", "<NOMBRE>", "<NOMBRE>", "<NOMBRE>", "JORGE", "<NOMBRE>", "ANDRES", "DAVID", "DANIEL",
    "<NOMBRE>", "ALEJANDRO", "JAIME", "CESAR", "ARMANDO", "<NOMBRE>", "<NOMBRE>", "ALIX",
    ...
    "GERMAN", "GUSTAVO", "HERNAN", "EDGAR", "<NOMBRE>", "WILSON", "FABIAN", "FELIPE",
    "<NOMBRE>", "NICOLAS", "MATEO", "SAMUEL", "GABRIEL", "EDUARDO", "RAFAEL", "ROBERTO",
    "PEDRO", "PABLO", "FRANCISCO", "ANTONIO", "MANUEL", "ALBERTO", "ALFONSO", "ALFREDO",
    "RUBEN", "RAUL", "VICTOR", "HECTOR", "MARCO", "<NOMBRE>", "ARTURO", "<NOMBRE>", "IVAN",
...
# Nombre/razón social en Título ("<NOMBRE> <NOMBRE> <NOMBRE> Gómez", "Indulacteos de
...
def _extraer_permiso(text: str) -> dict[str, Any]:
    ...
    # después en la misma fila (p.ej. el nombre de la empresa: "<NOMBRE> <NOMBRE>
    # <NOMBRE> Gomez" + "Indulacteos de" se verían como un solo nombre de 6
